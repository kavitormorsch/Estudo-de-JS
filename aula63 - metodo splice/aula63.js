...
const removed = names.splice(1, 1); //Number.Max_value é o maior valor que o javascript pode chegar, nesse caso ele serve para pegar o maior número de elementos do array que é possível baseado no indíce de início
console.log(names);
console.log(removed);